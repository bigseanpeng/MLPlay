...
"""
#   python MLGame.py -i ml_play_template_RandonCut.py -f60 arkanoid NORMAL 5
...
class MLPlay:
    ...
    def update(self, scene_info):
        ...
        if ball_going_down == 1 and ball_position_history[-1][1] >= 385:
            #Always Cut Ball
            #if ball_position_history[-1][0]-ball_position_history[-2][0]>0:
            #        command = "MOVE_RIGHT" # Cut ball
            #        command = "MOVE_LEFT" # Reverse Cut ball
            #    else: 
